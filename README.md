...
Full tables, statistics and limitations: [results.md](docs/paper/results.md). The full manuscript draft: [manuscript.md](docs/paper/manuscript.md). Regenerate every number yourself with `python3 eval/campaign_report.py`.
