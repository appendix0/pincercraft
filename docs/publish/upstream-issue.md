...
Full traces (episode JSONLs + referee verdicts + human gold labels) are published as a dataset: https://huggingface.co/datasets/Appendix0/pincercraft-say-do-gap. A worked before/after on one task is here: [receipt doc](https://github.com/appendix0/pincercraft/blob/develop/docs/receipts/2026-07-12-search-miss-before-after.md).
