...
| Headline number: claimed-vs-verified gap | ❌ needs two-arm campaign | the proof; the one thing HN can't dismiss |
| Referee-agreement % | ❌ needs 6 human labels (10 min, in-game) | pre-empts "why trust your referee?" |
| README | 🟡 good body; missing numbers, demo, receipt link; upstream link stale (repo moved to mindcraft-bots) | the landing page |
...
| Upstream issue/PR draft | ❌ recon done (docs/publish/2026-07-14-upstream-recon.md) | ring-1 artifact |
| Discord post draft | ❌ | ring-1 artifact |
| Show HN / Reddit drafts | ❌ | ring-3 artifacts |

## Sequence

**Phase 0 — build the assets (now, parallel with campaign):**
...
3. Owner labels the 6 calibration attempts → agreement %.
4. Two-arm benchmark campaign runs unattended (new delta benchmarks,
